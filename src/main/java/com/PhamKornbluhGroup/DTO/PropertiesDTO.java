...
public class PropertiesDTO {
    private String name; // Ex: "Wand"/"Physical Damage"
    private String[] values; // Ex: "[ ]" / "27-50", 0;  TODO: could be 2D array
    private int displayMode; // Ex: "0"
    private int type; // Ex: "9" //p Note: Optional Field

// Continue here 'requirement"
    /**
     {
     ...
     "implicitMods" : [ "17% increased Spell Damage" ],
     "explicitMods" : [ "61% increased Spell Damage", "24% increased Cold Damage", "+36% to Global Critical Strike Multiplier" ],
     "craftedMods" : [ "54% increased Spell Critical Strike Chance" ],
     "frameType" : 2,
     "extended" : {
     "category" : "weapons",
     "subcategories" : [ "wand" ],
     ...
     "implicitMods" : [ "+12% Chance to Block Attack Damage while wielding a Staff" ],
     "explicitMods" : [ "49% increased Spell Damage", "12% increased Critical Strike Chance" ],
     "frameType" : 1,
     "extended" : {
     "category" : "weapons",
     "subcategories" : [ "twomelee", "staff" ],
     "prefixes" : 1,
     "suffixes" : 1
     },
     "x" : 2,
     ...
     "explicitMods" : [ "54% increased Spell Damage", "72% increased Physical Damage", "9% increased Cold Damage", "22% increased Lightning Damage", "+42 to maximum Mana" ],
     "frameType" : 2,
     "extended" : {
     "category" : "weapons",
     "subcategories" : [ "wand" ],
     ...
     "implicitMods" : [ "+12% Chance to Block Attack Damage while wielding a Staff" ],
     "explicitMods" : [ "35% increased Critical Strike Chance" ],
     "frameType" : 1,
     "extended" : {
     "category" : "weapons",
     "subcategories" : [ "twomelee", "staff" ],
     ...
     "explicitMods" : [ "94% increased Armour", "+85 to maximum Life", "+35% to Cold Resistance", "+42% to Lightning Resistance", "+21% to Chaos Resistance" ],
     "frameType" : 2,
     "extended" : {
     "category" : "armour",
     "subcategories" : [ "chest" ],
     ...
     "implicitMods" : [ "+18 to Strength and Dexterity" ],
     "explicitMods" : [ "+9 to all Attributes", "19% increased Spell Damage", "22% increased Mana Regeneration Rate", "+44% to Fire Resistance" ],
     "frameType" : 2,
     "extended" : {
     "category" : "accessories",
     "subcategories" : [ "amulet" ],
     "prefixes" : 1,
     "suffixes" : 3
     },
     "x" : 9,
     ...
     "implicitMods" : [ "+12% Chance to Block Attack Damage while wielding a Staff" ],
     "explicitMods" : [ "+26 to Strength", "115% increased Spell Damage", "22% increased Lightning Damage", "Adds 2 to 4 Cold Damage to Spells", "+30% to Global Critical Strike Multiplier", "+14 to maximum Mana" ],
     "frameType" : 2,
     "extended" : {
     "category" : "weapons",
     "subcategories" : [ "twomelee", "staff" ],
     ...
     "explicitMods" : [ "Adds 1 to 23 Lightning Damage to Attacks", "+15% to Global Critical Strike Multiplier", "+81 to maximum Life", "21% increased Projectile Speed", "10% increased Elemental Damage with Attack Skills" ],
     "frameType" : 2,
     "extended" : {
     "category" : "armour",
     "subcategories" : [ "quiver" ],
     "prefixes" : 3,
     "suffixes" : 2
     },
     "x" : 2,
     ...
     "implicitMods" : [ "+20% to Global Critical Strike Multiplier" ],
     "explicitMods" : [ "125% increased Physical Damage", "Adds 1 to 4 Fire Damage", "Adds 32 to 54 Cold Damage", "6% increased Attack Speed", "27% increased Stun Duration on Enemies" ],
     "frameType" : 2,
     "extended" : {
     "category" : "weapons",
     "subcategories" : [ "onemelee", "rapier", "onesword" ],
     "prefixes" : 3,
     "suffixes" : 2
     },
     "x" : 8,
     ...
     "explicitMods" : [ "Adds 4 to 9 Physical Damage to Attacks", "Adds 20 to 43 Fire Damage to Attacks", "Adds 1 to 2 Cold Damage to Attacks", "20% increased Rarity of Items found", "+32% to Fire Resistance" ],
     "frameType" : 2,
     "extended" : {
     "category" : "accessories",
     "subcategories" : [ "amulet" ],
     ...
     "explicitMods" : [ "50% increased Spell Damage", "Adds 4 to 48 Lightning Damage to Spells", "36% increased Critical Strike Chance", "+11% to Global Critical Strike Multiplier" ],
     "frameType" : 2,
     "extended" : {
     "category" : "weapons",
     "subcategories" : [ "wand" ],
     ...
     "explicitMods" : [ "+2 to Level of Socketed Bow Gems", "Adds 21 to 41 Physical Damage", "Grants 4 Life per Enemy Hit", "+35 to Accuracy Rating", "10% increased Light Radius" ],
     "frameType" : 2,
     "extended" : {
     "category" : "weapons",
     "subcategories" : [ "bow" ],
