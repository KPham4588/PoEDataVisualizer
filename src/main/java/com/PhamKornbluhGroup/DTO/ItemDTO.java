...
public class ItemDTO {
    ...
    public ItemDTO(int dbId, String artFilename, String baseType, String colour, String descrText, String flavourTextNote, String forum_note, String icon, String id, String inventoryId, String league, String name, String note, String prophecyText, String rarity, String secDescrText, String stackSizeText, String typeLine, boolean abyssJewel, boolean cisRaceReward, boolean corrupted, boolean delve, boolean duplicated, boolean elder, boolean foreseeing, boolean fractured, boolean identified, boolean isRelic, boolean lockedToAccount, boolean lockedToCharacter, boolean memoryItem, boolean replica, boolean ruthless, boolean seaRaceReward, boolean searing, boolean shaper, boolean split, boolean support, boolean synthesised, boolean tangled, boolean thRaceReward, boolean unmodifiable, boolean veiled, boolean verified, boolean unmodifiableExceptChaos, int foilVariation, int ilvl, int itemLevel, int maxStackSize, int parentItemId, int publicStashChangeId, int stackSize, int talismanTier, long h, long socket, long w, long x, long y, CrucibleDTO crucible, ExtendedDTO extended, FrameType frameType, HybridDTO hybrid, IncubatedItemDTO incubatedItem, InfluencesDTO influences, ScourgedDTO scourged, ArrayList<String> cosmeticMods, ArrayList<String> craftedMods, ArrayList<String> crucibleMods, ArrayList<String> enchantMods, ArrayList<String> explicitMods, ArrayList<String> flavourText, ArrayList<String> fracturedMods, ArrayList<String> implicitMods, ArrayList<String> scourgeMods, ArrayList<String> utilityMods, ArrayList<String> veiledMods, ArrayList<ItemDTO> socketedItems, ArrayList<ItemPropertyDTO> additionalProperties, ArrayList<ItemPropertyDTO> nextLevelRequirements, ArrayList<ItemPropertyDTO> notableProperties, ArrayList<ItemPropertyDTO> properties, ArrayList<ItemPropertyDTO> requirements, ArrayList<ItemSocketDTO> sockets, ArrayList<LogbookModsDTO> logbookMods, ArrayList<Object> flavourTextParsed, ArrayList<RewardsDTO> rewards, ArrayList<UltimatumModsDTO> ultimatumMods) {
        this.dbId = dbId;
